...
(function() {
  ...
  function createDivInfoElement(info) {
    ...
    div.innerHTML = info.verbose;
    div.setAttribute(DATA_ATTRIBUTE_NAMES[info.type], info.code);
    if (info.hasOwnProperty('containerSelector')) {
      div.setAttribute(DATA_ATTRIBUTE_NAMES.containerSelector, info.containerSelector);
    }
    return div;
  }
  ...
  function addListeners() {
    ...
    document.getElementById(ELEMENTS_IDS.editorCancelButton).addEventListener('click', closeCodeEditor);
